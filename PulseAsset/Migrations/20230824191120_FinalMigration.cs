        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockoutEnd = table.Column<DateTimeOffset>(type: "VARCHAR(20)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { -1, "This is the default category seeded by the application on setup. Feel free to edit it!", "Default Category" });

            migrationBuilder.InsertData(
                table: "Locations",
                columns: new[] { "LocationId", "Address", "Name" },
                values: new object[] { -1, "123 Main St, New York, NY 10001", "Default Location" });
        }
